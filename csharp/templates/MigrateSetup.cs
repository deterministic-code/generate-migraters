...
{
    private const string SqliteMigratesDdl = """
{{sqliteMigratesDdl}}
""";

    private const string SqliteMigrateLogsDdl = """
{{sqliteMigrateLogsDdl}}
""";

    private const string PostgresMigratesDdl = """
{{postgresMigratesDdl}}
""";

    private const string PostgresMigrateLogsDdl = """
{{postgresMigrateLogsDdl}}
""";

    private const string MysqlMigratesDdl = """
{{mysqlMigratesDdl}}
""";

    private const string MysqlMigrateLogsDdl = """
{{mysqlMigrateLogsDdl}}
""";
