...
const CS_FILES = [
  ...
  { file: "Program.cs" },
  { file: "IMigrateCommand.cs" },
  { file: "ISqlDialect.cs" },
  { file: "ISqlDialectFactory.cs" },
  { file: "SqlDialectFactory.cs" },
  { file: "IConnectionResolver.cs" },
  { file: "ConnectionResolver.cs" },
  { file: "SqlDialectBase.cs" },
  { file: "SqliteDialect.cs" },
  { file: "PostgresDialect.cs" },
  { file: "MysqlDialect.cs" },
  { file: "ConnectionStringUrl.cs" },
  { file: "MigrateRunnerServices.cs" },
  { file: "DbExecute.cs" },
  { file: "FnvChecksum.cs" },
  { file: "SqlStatementSplitter.cs" },
