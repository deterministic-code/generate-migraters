...
const SQLITE_MIGRATES_DDL: &str = r#"{{sqliteMigratesDdl}}"#;
const SQLITE_MIGRATE_LOGS_DDL: &str = r#"{{sqliteMigrateLogsDdl}}"#;
const POSTGRES_MIGRATES_DDL: &str = r#"{{postgresMigratesDdl}}"#;
const POSTGRES_MIGRATE_LOGS_DDL: &str = r#"{{postgresMigrateLogsDdl}}"#;
const MYSQL_MIGRATES_DDL: &str = r#"{{mysqlMigratesDdl}}"#;
const MYSQL_MIGRATE_LOGS_DDL: &str = r#"{{mysqlMigrateLogsDdl}}"#;

const HELP_TEXT: &str = r#"{{helpText}}"#;
